...
function dragElement(elmnt,header) {
    ...
    function dragMouseDown(e) {
        ...
        pos3 = e.clientX;
        pos4 = e.clientY;
        frame.document.onmouseup = closeDragElement;
        // call a function whenever the cursor moves:
        frame.document.onmousemove = elementDrag;
    }
...
function manSearchWin(){
    ...
    d.innerHTML="<div id='tttheader'><table width='100%' style='border-bottom:1px solid silver'><tr><td><div class='ttTraWord' title='Type word in sinhala or english'>Word: <input type='text' id='manSearchWord' class='ttInpt' size=35></input><button id='manSearch' class='ttBtn' >Search</button></div></td><td align=right><button style='color:green' id='ttBtnAdd' class='ttBtn' title='Add'>+</button><button style='color:red' title='Close' id='ttBtnClose' class='ttBtn'>x</button></td></tr></table></dev><div id='ttDef'></div>";
